...
user_input = input("Enter the folder location: ")
...
def detect_multiple_texts_in_video(video_path, target_texts, frame_interval, display_duration, ignore_range, display_scale, crop_bottom_height=360):
    ...
    for frame_number in range(0, total_frames, frame_interval):
        ...
        # Crop the frame to the specified aspect ratio (16:3)
...
timestamps_dict = detect_multiple_texts_in_video(video_path, target_texts, frame_interval=60, display_duration=1000, ignore_range=8, display_scale=0.2)
